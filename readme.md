...
This project implements the CNN model for stock price trend prediction based on the paper "(Re-)Imag(in)ing Price Trends". The model converts OHLC (Open, High, Low, Close) price data into images and uses CNN to predict future price movements.
The group members include: Jiaxin lIU and Pengtu XUE
